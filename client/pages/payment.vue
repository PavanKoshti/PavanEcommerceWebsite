...
export default {
    ...
    mounted() {
        // Publishable key
        this.stripe = Stripe("pk_test_51N3J6aIkBmBk56Uz10j7RL4NXbu3T21ExnwNIa4QZQWD65Lb79QUgIuXYOv9MRUerAYH9HoNq1kbhIkmQa8cP7ih00AiGBv3ay");
    ...
    methods: {
        async onPurchase() {
            try {
                ...
                console.log("Error While Get Save Purchase Order >>>", err);
            }
        }
    }
};
