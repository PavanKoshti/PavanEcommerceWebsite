                            ...
                            <div v-for="product in order.products" :key="product._id">
                                ...
                                <div class="row">
                                    <div class="col-xl-2 col-lg-2 col-2">
                                        <!-- Product's image -->
                                        <a href="#">
                                            <img :src="baseURL + product.productID.photo" class="img-fluid"
                                                style="width: 100px;" />
                                        </a>
                                    </div>
                                    <div class="col-xl-10 col-lg-10 col-10">
                                        ...
                                        <div class="a-row">
                                            <span class="a-size-mini a-color-secondary">Sold by: Amazon Export Sales
                                                LLC</span>
                                        </div>
                                        <div class="a-row">
                                            <!-- Product quantity -->
...
export default {
    async asyncData({ $axios }) {
        try {
            ...
            console.log("Error While Get Order List >>>", err);
        }
    },
    data() {
        return {
