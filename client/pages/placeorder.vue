            ...
            <div class="shipping-address">
                <div class="navbarShipping a-spacing-large">
                    <nuxt-link to="/">
                        ...
                        <img src="../static/img/placeHeadernav.gif" class="img-fluid" />
                    </nuxt-link>
                </div>
                <div class="a-row">
                                            ...
                                            <div class="a-row">
                                                <div class="displayAddressDiv">
                                                    ...
                                                    <ul class="displayAddressUL">
                                                        ...
                                                        <li>
                                                            Phone:
                                                            <span dir="ltr">{{ $auth.$state.user.address.phoneNumber }}
                                                            </span>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <ul class="no-bullet-list">
                                                    <li class="a-spacing-micro">
                                                        <span class="a-list-item">
                                                            <span>
                                                                <img src="../static/img/visa.gif" class="img-fluid" />
                                                            </span>
                                                            ending in
                                                            <span>6397</span>
                                                        </span>
                                        ...
                                        <div class="a-spacing-base">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-7 col-8 pr-0">
                                                    <input type="text" autocomplete="off" class="a-input-text"
                        ...
                        <div class="spc-orders a-box">
                            <div class="a-box-inner">
                                <div class="shipping-group">
                                    <!-- Estimated delivery -->
                                    <div class="a-row a-color-state a-text-bold a-size-medium a-spacing-small">Estimated
                                        delivery: {{ estimatedDelivery }}</div>
                                    <div class="row">
                                        <!-- Cart -->
                                            ...
                                            <div class="a-row a-spacing-base" v-for="product in getCart" :key="product._id">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 col-3">
                                                        <img :src="baseURL + product.photo" style="width: 100px;" />
                                                    </div>
                                                    <!-- Product's Title -->
                                                    <div class="col-sm-9 col-9">
                                                        ...
                                                        <div class="a-row a-color-secondary a-size-small">Sold
                                                            by:&nbsp;Amazon.com Services, Inc</div>
                                                        <div class="a-row">
                                                            <div class="a-row a-spacing-top-micro">
                                                                <span class="a-button-small">
                                                                    <span class="a-button-inner">
                                                                        ...
                                                                        <a href="#"
                                                                            class="a-button-text gift-popover-link">Add a
                                                                            gift receipt</a>
                                                                    </span>
                                                                </span>
                                                            </div>
                                                            <div class="a-row">
                                                                <span class="a-color-secondary a-size-mini">and see other
                                                                    gift options</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="a-spacing-mini wednesday">
                                                        ...
                                                        <span class="a-radio-label">
                                                            ...
                                                            <br />
                                                            <span class="a-color-secondary">$13.98&nbsp;-&nbsp;Standard
                                                                International Shipping - No Tracking</span>
                                                        </span>
                                                    </div>
                                                    <br />
                                                    <div class="a-spacing-mini tuesday">
                                                        ...
                                                        <span class="a-radio-label">
                                                            ...
                                                            <br />
                                                            <span
                                                                class="a-color-secondary">$49.98&nbsp;-&nbsp;Shipping</span>
                                                        </span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                    ...
                                    <div class="a-row">
                                        ...
                                        <div class="order-summary" style="font-size: 12px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 text-right">USD {{ getCartTotalPriceWithShipping }}
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 text-right">
                                                    <!-- Total Price with Shipping -->
                                                    <div class="a-color-price a-size-medium a-text-bold">USD {{
                                                        getCartTotalPriceWithShipping }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="a-box-inner">
                                    ...
                                    <div class="a-size-mini">
                                        <div class="a-row a-spacing-mini mb-1">
                                            Please note that your country may charge import duties, taxes and fees that you
                                            may have to pay ahead of delivery.
                                            <a href="#">Learn more</a>
                                        </div>
                                        <div class="a-row a-spacing-mini mb-1">
                ...
                <div class="a-row a-spacing-small a-spacing-top-small">
                    ...
                    <p class="a-color-secondary a-size-mini">For an item sold by Amazon.com: When you click the "Place your
                        order" button, we'll send you an email message acknowledging receipt of your order. Your contract to
                        purchase an item will not be complete until we send you an email notifying you that the item has
                        been shipped.</p>
                    ...
                    <div class="a-color-secondary a-size-mini">
                        <p class="a-color-secondary a-size-mini">
                            ...
                            Exceptions and restrictions apply. See Amazon.com's
...
export default {
    ...
    async asyncData({ $axios, store }) {
        try {
            ...
            console.log("Error While Get Shipment Data >>>", err);
        }
    },
    computed: {
        ...mapGetters([
    ...
    methods: {
        async onChooseShipping(shipment) {
            try {
                ...
                console.log("Error While Get Change Shipping >>>", err);
             }
        }
    }
};
