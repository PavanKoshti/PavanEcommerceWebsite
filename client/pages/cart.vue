                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-2 col-2">
                          <a href="#" class="a-link-normal">
                            <img :src="baseURL + product.photo" class="img-fluid w-100" />
                          </a>
                        </div>
                        <div class="col-sm-8 col-8">
                          ...
                          <div class="sc-action-links">
                            <select @change="onChangeQuantity($event, product)"> 
                              <option v-for="i in 10" :key="i" :value="i" :selected="checkQty(product.quantity, i)">Qty: &nbsp;{{i}}
                              </option>
                            </select>
                            &nbsp;&nbsp;
                            <span>|</span>
                        ...
                        <span class="a-list-item">
                          <div class="row">
                            <div class="col-md-4 col-sm-3 col-3 pl-0">
                              <a href="#">
                                <img src="../static/img/cartRecent4.png" class />
                              </a>
                            </div>
