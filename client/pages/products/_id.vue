    ...
    <main>
                ...
                <ul class="a-unordered-list a-horizontal a-size-small">
                    <li>
                        <span class="a-list-item">
                            <a class="a-link-normal a-color-tertiary" href="#"> {{ singleProduct.catgType }} </a>
                        </span>
                    </li>
                    <li>
                    ...
                    <li>
                        <span class="a-list-item">
                            <a class="a-link-normal a-color-tertiary" href="#"> {{ singleProduct.title }} </a>
                        </span>
                    </li>
                </ul>
            </div>
        ...
        <div class="container-fluid">
            <div class="dp-container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4">
                        <div class="leftCol">
                            ...
                            <div clas="imgBlock">
                                <div class="eBooksimg">
                                    <img :src="baseURL+singleProduct.photo" class="img-fluid" />
                                </div>
                            </div>
                            <!-- Follow Author -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                            <div class="smallAuthorImageContainer">
                                                <a href="#">
                                                    <img :src="baseURL+singleProduct.ownerPhoto" class="img-fluid" />
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Author's Name -->
                                        <div class="col-xl-4 col-lg-3 col-md-3 col-sm-3 col-3">
                                            <div class="authorNameCol">
                                                <a href="#">{{ singleProduct.ownerName }}</a>
                                            </div>
                                        </div>
                        ...
                        <div class="centerCol">
                            ...
                            <div class="titleDiv">
                                <h1 class="productTitle">
                                    <span class="largeTitle"> {{ singleProduct.title }} </span>
                            ...
                            <div class="reviewGroup">
                                <no-ssr>
                                    <star-rating :rating="singleProduct.averageRating" :show-rating="false" :glow="1"
                                            ...
                                            <span class="a-list-item">
                                                <span class="a-button-toggle">
                                                    <span class="a-button-inner">
                                                        <a href="#" class="a-button-text">
                                                            <span> 
                                                                <img src="../../static/img/audiblelogo.png" class="img-fluid"
                                                                    style="width: 20px;" />Audible
                                                            </span>
                                                            <br />
                                                            <span class="a-color-secondary">-</span>
                                                        </a>
                                                ...
                                                <span class="tmm-olp-links">
                                                    <a href="#" class="a-size-mini">
                                                        <span class="kcpAppBox">
                                                            <span class="a-declarative">
                                                                <span class="a-text-bold">Free App</span> with your Audible
                                                                Trial
                                                            </span>
                                                        </span>
                                                    </a>
                            ...
                            <div class="bookDescription">
                                <div class="bookDescriptionInner">{{ singleProduct.description }}</div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                            ...
                            <div class="buyBox">
                                ...
                                <div class="a-section">
                                    <div class="clearfix">
                                        ...
                                        <div class="float-right">
                                            <span class="a-color-base offer-price a-text-normal">${{ singleProduct.price }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="kcpAppBaseBox text-center">
                            <img src="../../static/img/readyondevice.png" class="img-fluid" />
                        </div>
                    </div>
                </div>
                <br />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-8 col-8 pl-0">
                                    <div class="mainContent">
                                        <h3>Biography</h3>
                                        <div id="authorBio">{{ singleProduct.ownerAbout }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <ReviewSection :product="singleProduct" :reviews="singleProductReviews" />
            </div>
        </div>
    </main>
</template>
...
export default {
    ...
    methods : {
        ...
        async onGetSingleProduct() {
            try {
                ...
                if (singleProductDetails.success == true) {
                    ...
                    this.singleProduct.reviewlength = singleProductDetails.product.reviews.length;
                }
                else {
        ...
        async singleProductManyReviews() {
            try {
                let singleProductReviews = await this.$axios.$get(`api/reviews/${this.$route.params.id}`);
                if (singleProductReviews.success == true) {
                    this.singleProductReviews = singleProductReviews.reviews;
                }
                else {
                    console.log("Error While Get Single Product Reviews >>>");
                }
                
            } catch (error) {
                console.log("Error While Get Single Product Reviews Catch >>>", error);
            }
        },
