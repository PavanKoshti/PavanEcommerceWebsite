        ...
        <div class="col-xl-10 col-lg-9 md-8 col-sm-8">
          ...
          <div class="mainResults">
            <ul class="s-result-list">
              <li v-for="product in allProductList" :key="product._id" class="s-result-item celwidget">
                  ...
                  <div>
                    <div class="row">
                      ...
                      <div class="col-sm-3 text-center">
                        <a href="#">
                          <img :src="baseURL+product.photo" style="width: 150px;" class="img-fluid" />
                        </a>
                      </div>
                      <div class="col-sm-9">
...
export default {
  ...
  methods: {
    ...
    async getAllProductsList() {
      try {
        let productList = await this.$axios.$get("api/products");
        ...
        console.log("Error White Get All Prodcuts List Catch >>>", error);
      }
    },
