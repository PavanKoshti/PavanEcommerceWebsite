            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-12">
                    ...
                    <a href="#" class="a-color-base">
                        <h2>{{ product.reviewlength }} customer reviews</h2>
                    </a>
                ...
                <div class="col-lg-6 col-md-7 col-sm-12">
                    <div class="reviews-image-gallery">
                        ...
                        <div class="a-spacing-small a-spacing-top-small">
                            <img class="img-fluid" width="22.5%" v-for="review in reviews" :key="review._id"
                    ...
                    <div class="cr-widget-focalreviews">
                        <div class="card-padding">
                            <div class="review-header">
                                <h3>
                                    <span class="a-size-base">Showing 1-8 of {{ product.reviewlength }} reviews</span>
                                </h3>
                            </div>
